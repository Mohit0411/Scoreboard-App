...
class ExtrasTab extends StatelessWidget {
  const ExtrasTab({required this.state, super.key});
...
class ExtrasCard extends StatefulWidget {
  const ExtrasCard({required this.options, required this.state, super.key});
  final ScoreboardOptions options;
  final HomeState state;

  @override
  State<StatefulWidget> createState() => _ExtrasCardState();
}
