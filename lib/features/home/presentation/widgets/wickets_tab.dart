...
class WicketsTab extends StatelessWidget {
  const WicketsTab({required this.state, super.key});
...
class WicketsCard extends StatefulWidget {
  const WicketsCard({required this.options, required this.state, super.key});
  final ScoreboardOptions options;
  final HomeState state;

  @override
  State<StatefulWidget> createState() => _WicketsCardState();
}

class _WicketsCardState extends State<WicketsCard> {
